...
<body class="font-sans antialiased body-full">
    ...
    {{-- STATISTICS --}}
    <div class="section-flex statistics-container">
        <div class="statistics students-statistics">
            <h1>1008</h1>
            <p>Jumlah Siswa</p>
        </div>

        <div class="statistics majors-statistics">
            <h1>4</h1>
            <p>Program Keahlian</p>
        </div>

        <div class="statistics industry-statistics">
            <h1>30</h1>
    ...
    <div class="news">
        <div class="transition-all duration-500 top-news hover:scale-90 hover:bg-neutral-neutral-100">
        ...
        <div class="recent-news">
            @foreach ($recentNews as $news)
                <div class="transition-all duration-500 news-card hover:scale-90 hover:bg-neutral-neutral-100">
                    <img src={{ $news->img }}>
