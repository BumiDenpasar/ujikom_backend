...
<body class="w-screen min-h-screen overflow-x-hidden font-sans pt-28 bg-gradient-to-b from-blue-50 via-blue-50 to-blue-100">
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex flex-col items-center p-6 text-gray-900">
                        <div class="flex flex-wrap mt-3">
                            ...
                            <a href={{route('show.event', $event)}} class="flex relative flex-col justify-between p-5 m-3 w-72 rounded-3xl hover:drop-shadow-2xl drop-shadow-lg h-[24rem] hover:scale-110 transition-all duration-500 bg-white">
                                <div>
    ...
    @else
    <div class="flex animate-fadeIn flex-col items-center justify-center w-full h-[70vh]">
