...
<body class="w-screen min-h-screen overflow-x-hidden font-sans bg-blue-50">

    <x-guest-nav />

    <div class="pb-12 animate-fadeIn pt-28">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="pb-10 overflow-hidden bg-transparent shadow-none md:bg-white md:shadow-xl sm:rounded-2xl">
                <div class="p-6 text-gray-900">
                    <a class="secondary-button" href="{{ route('news') }}">
                    ...
                    <div class="flex flex-wrap w-full px-5 mt-8 space-x-1">
                        ...
                        <div class="relative flex items-center justify-center h-10 px-4 overflow-hidden text-sm font-bold text-white bg-blue-600 bg-center bg-cover shadow-lg rounded-2xl" >
                               {{ $category->title}}
                            </div>
                        @endforeach
                        ...
                        <div class="relative group chat chat-start">
                            ...
                            <div class="chat-header">
                                ...
                                <time class="text-xs opacity-50">{{
                                    \Carbon\Carbon::parse($comment->created_at)->format('H:i') }}</time>
                            </div>
