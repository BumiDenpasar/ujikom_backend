...
<body class="w-screen min-h-screen overflow-x-hidden font-sans bg-gradient-to-b from-blue-50 via-blue-50 to-blue-100">
    
    <x-guest-nav />
    
    @if ($newses->isNotEmpty())
        <div class="pb-12 pt-28 animate-fadeIn">
                                ...
                                <div
                                    ...
                                    <div class="relative flex flex-col justify-between w-full h-full">
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('show.news', $news) }}"
                                                class="absolute see-button-rounded right-3 bottom-5">
                                                <div class="w-4">
                                                    @svg('heroicon-c-eye')
                                                </div>
                                            </a>
